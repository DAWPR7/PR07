...
<body>
  <div class="jumbotron">
    <div class="container"><img src="img/theme_header_Animalrace.png"></div>
    <div class="container" style="background-color: white;">
      ...
      <form method="post" id="formulario" role="form">
        ...
        <div class="form-group container">
          ...
          <input type="password" class="form-control" id="pre_3" name="pre_3" 
        ...
        <div class="form-group container">
          <label for="formulario">Alumne/-na que pateix Bullying </label>
          <input type="password" class="form-control" id="pre_7"  name="pre_7"
                 placeholder="Resposta">
        </div>
        ...
        <div class="form-group container">
          <label for="formulario">Alumne/-na que pateix Bullying </label>
          <input type="password" class="form-control" id="pre_8" name="pre_8" 
                 placeholder="Resposta">
        </div>
        <div class="col-md-offset-2">
          <div class="checkbox">
        ...
        <div class="form-group container">
          <label for="formulario">Alumne/-na que pateix Bullying </label>
          <input type="password" class="form-control" id="pre_9" name="pre_9" 
                 placeholder="Resposta">
        </div>
        <div class="col-md-offset-2">
          <div class="checkbox">
        ...
        <button id="btn_enviar" type="submit" class="btn btn-default">Enviar</button>
        </div>
      </form>
    </div>
