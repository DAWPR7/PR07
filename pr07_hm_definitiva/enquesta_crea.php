...
<div class="container">
  <div class="page-header">
    <h1>Generador d'enllaços a l'enquesta de bullying</h1>
  </div>
</div>
...
<body >
  <div class="container" style="background-color: lightgrey;">
      <form class="navbar-form navbar-left" role="search">
        ...
        <label> Selecciona el teu nom:</label>
        <select class="form-control" name="nom" id="nom"  disabled>
              <option selected disabled>nom</option>
              <!-- <option value='1'>1</option>
              <option value='2'>2</option>
              <option value='3'>3</option>
              <option value='4'>4</option>
...
$('#curs').change(function() {
    ...
    if(cicle!=null){etapa=cicle};
        ...
        $.ajax({
            type: "POST",
            data: {"alu_etapa" : etapa, "alu_curso" : curs},
...
$('#nom').change(function() {
    ...
    // enquesta.php?id=2&alu_etapa=PRIMARIA&alu_curso=6


    var insert = 'enquesta.php?id='+id+'&alu_etapa='+etapa+'&alu_curso='+curs;
